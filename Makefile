...
ddraw.dll: classfactory.cpp clipper.cpp color.cpp dd.cpp dds.cpp dllmain.cpp gama.cpp dx.cpp header.h log.cpp log.h palette.cpp unknwn.cpp wrap.cpp wrap.h exports.def ddraw.rc.o 
	gcc -m32 -static-libgcc -Wl,--enable-stdcall-fixup,--gc-sections -s -O2 -shared -o ddraw.dll classfactory.cpp clipper.cpp color.cpp dd.cpp dds.cpp dllmain.cpp dx.cpp gama.cpp log.cpp palette.cpp unknwn.cpp wrap.cpp exports.def ddraw.rc.o -lddraw -lgdi32
